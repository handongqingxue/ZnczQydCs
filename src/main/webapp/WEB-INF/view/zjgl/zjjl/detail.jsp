...
<div class="layui-layout layui-layout-admin">
	...
	<div class="center_con_div" id="center_con_div">
		<div class="page_location_div">质检管理-质检记录-详情</div>
		...
		<div id="detail_div">
			...
			<table>
			  <tr>
				...
				<td class="td2">
					${requestScope.zjjl.ddh }
				</td>
				<td class="td1" align="right">
					订单状态
				</td>
				<td class="td2">
					${requestScope.zjjl.ddztMc }
				</td>
			  </tr>
			  <tr>
				<td class="td1" align="right">
				...
				<td class="td2">
					<c:choose>
						<c:when test="${requestScope.zjjl.jg eq 1 }">合格</c:when>
			  ...
			  <tr>
				...
				<td class="td2">
					${requestScope.zjjl.zjsj }
				</td>
				<td class="td1" align="right">
					备注
				</td>
				<td class="td2">
					${requestScope.zjjl.bz }
				</td>
			  </tr>
			</table>
			</form>
