...
<div class="layui-layout layui-layout-admin">
	...
	<div class="center_con_div" id="center_con_div">
		<div class="page_location_div">排队管理-排队记录-详情</div>
		...
		<div id="detail_div">
			...
			<table>
			  <tr>
				...
				<td class="td2">
					${requestScope.pdjl.ddh }
				</td>
				<td class="td1" align="right">
					车牌号
				</td>
				<td class="td2">
					${requestScope.pdjl.cph }
				</td>
			  </tr>
			  <tr>
				<td class="td1" align="right">
				...
				<td class="td2">
					${requestScope.pdjl.dlh }
				</td>
				<td class="td1" align="right">
					排队号
				</td>
				<td class="td2">
					${requestScope.pdjl.pdh }
				</td>
			  </tr>
			  <tr>
				<td class="td1" align="right">
				...
				<td class="td2">
					${requestScope.pdjl.pdsj }
				</td>
				<td class="td1" align="right">
					状态
				</td>
				<td class="td2">
					<c:if test="${requestScope.pdjl.zt eq 1 }">排队中</c:if>
					<c:if test="${requestScope.pdjl.zt eq 2 }">已完成</c:if>
					<c:if test="${requestScope.pdjl.zt eq 3 }">已过号</c:if>
				</td>
			  </tr>
			</table>
			</form>
